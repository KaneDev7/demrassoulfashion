...
function showBoxForm(){
    ...
    input_id.value = null
    formTitle.innerText = 'Ajouter un article pour les vetements'
...
cards.forEach((img, i) =>{
    ...
    img.addEventListener('click',()=>{
        ...
        try{
            fetch('http://localhost:3001/collection/article_vetement')
            .then(res => res.json())
            .then(result =>{
...
deletBtn.addEventListener('click', (e)=>{
   ...
   if(confirme === true){
    ...
    link.href= `/detelet_image/${imageSrc}/article_vetement/${selectImg_id}/vetement`
    link.click()
