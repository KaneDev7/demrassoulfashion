...
function showBoxForm(){
    ...
    input_id.value = null
    formTitle.innerText = 'Ajouter un article pour les les sacs et accessoires'
...
cards.forEach((img, i) =>{
    ...
    img.addEventListener('click',()=>{
        ...
        try{
            fetch('http://localhost:3001/collection/article_sacs_accessoires')
            .then(res => res.json())
            .then(result =>{
...
deletBtn.addEventListener('click', (e)=>{
   ...
   if(confirme === true){
    ...
    link.href= `/detelet_image/${imageSrc}/article_sacs_accessoires/${selectImg_id}/accssessoire`
    link.click()
